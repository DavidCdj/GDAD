...
public class PantallaPrincipal extends JFrame {
    ...
    ImageIcon icono= new ImageIcon("settings.png");
    ...
    private void Componentes() {
        ...
        jbDedosColores.setBounds(450, 450, 180, 30);
        ...
        jbDedosArriba.setBounds(450, 560, 180, 30);
        ...
        jbDedosColores.addActionListener(e-> {
            ...
            ControlDedosColores controlador = new ControlDedosColores();
            new Thread(() -> {
                controlador.ejecutarActividadPython(PantallaPrincipal.this);
            }).start();

        });

        jbDedosArriba.addActionListener(new ActionListener() {
            
            public void actionPerformed(ActionEvent e) {
                PantallaDedosArriba ventanaNueva = new PantallaDedosArriba();
                ventanaNueva.setVisible(true);
                dispose();
            }
        });
