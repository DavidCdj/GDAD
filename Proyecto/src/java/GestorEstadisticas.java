...
public class GestorEstadisticas {
    ...
    private static final String RUTA = RutaAplicacion.recurso("estadisticas.txt").getAbsolutePath();
    ...
    public static void migrarDesdeCSV() {
        String rutaCsv = RutaAplicacion.archivo("estadisticas.csv").getAbsolutePath();
